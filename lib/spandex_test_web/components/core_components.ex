defmodule SpandexTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpandexTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpandexTestWeb.Gettext, "errors", msg, opts)
    end
  end
